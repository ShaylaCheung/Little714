...
public class SetUserActivity extends AppCompatActivity implements LoginReceiver.OnLoginListener,
        SignInReceiver.OnSignInListener {
    ...
    private static CircularImageView change_user_image;
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                ...
                case UPDATE_SUCCESS:
                    ...
                    update_user_name.clearFocus();
//                    update_user_name.setFocusableInTouchMode(false);
                    update_user_phone.clearFocus();
//                    update_user_phone.setFocusableInTouchMode(false);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        change_user_image = (CircularImageView) findViewById(R.id.change_user_image);
        ...
        loginReceiver = new LoginReceiver(this){
            ...
            public void onReceive(Context context, Intent intent) {
                ...
                set_name_text.setText(intent.getStringExtra("user_name"));
                set_phone_text.setText( intent.getStringExtra("user_phone"));
                StateUtils.setUser_name(set_name_text.getText().toString());
                StateUtils.setUser_phone(set_phone_text.getText().toString());
            }
        };
    ...
    public void initSetView() {
        if (StateUtils.isLogin()) {
            //已经登录成功
            change_user_image.setImageResource(R.drawable.user_image_login);
